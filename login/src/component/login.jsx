        ...
        <div>
            <div className="bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative">
                ...
                <form action="">
                    ...
                    <button className="w-full mb-4 text-[18px] font-bold mt-6 rounded-full bg-white text-purple-800  hover:bg-purple-800 hover:text-white border-2 hover:border-white py-2 transition-colors duration-300" type ="submit">Login</button>
                    <div>
                        <span className="m-6">New Here ? <Link className="text-red-500" to='/Register' >Create an Account</Link></span>
                    </div>
                </form>
            </div>
        </div>
